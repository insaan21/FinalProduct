...
instr 1
	...
	loop:
	irDelayTime chnget "rDelay"
    ilDelayTime chnget "lDelay"
    timout 0, 5, play 
    reinit loop
...
instr 2
   ;changing values for delay
    ;gkrDelayTime chnget "rDelay"
	;gklDelayTime chnget "lDelay"
